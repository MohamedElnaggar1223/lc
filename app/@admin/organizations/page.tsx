...
{
    const { organizations, removeOrganization } = useOrganizationStore()
    ...
    return (
        <section className='flex flex-col gap-8 px-8 py-8 overflow-auto'>
            <div className='relative border-[rgba(0,59,51,0.5)] border-4 flex px-1.5 py-1.5 w-screen max-w-[658px] text-[rgba(0,59,51,0.5)] rounded-lg bg-[#fff] mx-auto max-h-[500px]'>
                ...
                {filtersOpen && (
                    <div ref={dropdownRef} onClick={(e) => e.stopPropagation()} className='absolute w-screen max-w-[647px] z-[999999999] bg-[#fff] flex flex-col text-sm top-[110%] gap-4 px-8 py-4 rounded-lg'>
