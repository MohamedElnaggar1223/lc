...
export type Organization = {
    ...
    lastName: string,
    address: string,
    area: "Maadi" | "Zamalek" | "Downtown" | "Heliopolis" | "Nasr City" | "6th of October City" | "Sheikh Zayed" | "New Cairo" | "El Rehab City" | "Madinet Nasr" | "El Shorouk City" | "El Tagamo' El Khames" | "El Obour City" | "El Mohandessin" | "El Agouza" | "El Dokki" | "El Haram",
...
export type PostsState = {
    ...
    updatePost: (id: number, post: PostType) => void,
    fullfillPost: (id: number, fullfilledBy: string) => void,
}
...
export const usePostsStore = create<PostsState>()((set) => ({
    posts: [
        ...
        },
        {
            ...
            details: {
                type: 'Books',
                bookName: 'Science 101',
                bookSummary: 'A book about basic science.',
                bookEdition: '1st Edition',
